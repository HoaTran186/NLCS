...
?>
    ...
    <body>
        <div class="sidebar">
            ...
            <ul class="side-menu">
                <li class="active"><a href="/PassdoSV.com/backend/Dashboard/dashboard.php"><i class='bx bxs-dashboard'></i>Dashboard</a></li>
        ...
        <div class="content">
            ...
            <main>
                ...
                <!-- End of Insights -->
                <?php
                if ($_SESSION['kh_quantri'] == 1) {
                    $sqlDHKH = "SELECT ddh.*,ttdh.ttdh_ten,kh.kh_ten
                FROM don_dat_hang ddh 
                JOIN trang_thai_don_hang ttdh ON ddh.ttdh_ma = ttdh.ttdh_ma
                JOIN khach_hang kh ON kh.kh_ma = ddh.kh_ma;";
                    $resultDHKH = mysqli_query($conn, $sqlDHKH);
                    $dataDHKH = [];
                    while ($row = mysqli_fetch_array($resultDHKH, MYSQLI_ASSOC)) {
                        $dataDHKH[] = array(
                            'ttdh_ma' => $row['ttdh_ma'],
                            'kh_ten' => $row['kh_ten'],
                            ...
                            <tbody>
                                <?php foreach ($dataDHKH as $dh) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if ($dh['ttdh_ma'] == 1) : ?>
                                                <span class="status completed"><?= $dh['ttdh_ten'] ?></span>
                                            <?php elseif ($dh['ttdh_ma'] == 2) : ?>
                                                <span class="status pending"><?= $dh['ttdh_ten'] ?></span>
                                            <?php else : ?>
                                                <span class="status process"><?= $dh['ttdh_ten'] ?>
                                                <?php endif; ?>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                    ...
                    <div class="reminders">
                        ...
                        <table style="padding-top: 100px;">
                            <?php foreach ($dataKH as $kh) : ?>
                                <tr>
                                    <td style="padding-right: 200px;"><img src="images/profile-1.jpg" style="width: 50px; border-radius: 50%;"></td>
                                    <td><?= $kh['kh_ten'] ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
