            ...
            <div class="header">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        /
                        <li><a href="#" class="active">Thêm</a></li>
                    </ul>
                </div>
                <a href="#" class="report">
            ...
            <div class="bottom-data">
                <div class="orders">
                    ...
                    if (isset($_SESSION['dadangnhap']) && $_SESSION['dadangnhap'] == false || !isset($_SESSION['dadangnhap'])) {
                        ...
                        <form action="" method="post" name="frmDangSP" id="frmDangSP" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Tên sản phẩm: </label>
                                <input type="text" name="sp_ten" id="sp_ten" placeholder="Nhập tên sản phẩm" class="form-control">
                            </div>
                            <div class="form-row">
                                <div class="col-md-6">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="sp_ngaycapnhat" id="sp_ngaycapnhat" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Mô tả sản phẩm</label>
                                <textarea name="sp_mota" class="form-control" id="sp_mota"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Loại sản phẩm:</label>
                                <select name="lsp_ma" class="form-control" id="lsp_ma">
                            ...
                            <div class="form-group">
                                ...
                                <select name="lh_ma" class="form-control" id="lh_ma">
                            ...
                            <div class="form-group">
                                ...
                                <select name="httt_ma" class="form-control" id="httt_ma">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                    <img src="../../assets/img/default_img.jpg" id="preview-img" style="width: 150px;">
                                </div>
                            </div>
                        ...
                        if (isset($_POST['btnLuu'])) {
                            ...
                            if (!empty($_FILES['hsp_tentaptin']['name'])) {
                                ...
                                $sqlISXN = "INSERT INTO xac_nhan_ban_sp
                        (sp_ten, sp_gia, sp_giacu, sp_soluong, sp_mota, sp_ngaycapnhat, hsp_tentaptin, lsp_ma, lh_ma, httt_ma,kh_ma)
                        VALUES ('$sp_ten', $sp_gia, $sp_giacu, $sp_soluong, '$sp_mota', '$sp_ngaycapnhat', '$newFile', $lsp_ma,$lh_ma, $httt_ma,$kh_ma);";
