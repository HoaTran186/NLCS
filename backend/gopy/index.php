    ...
    <div class="sidebar">
        ...
        <ul class="side-menu">
            ...
            <?php if ($_SESSION['kh_quantri'] == true) { ?>
                <li class="active"><a href="/PassdoSV.com/backend/gopy/index.php"><i class='bx bx-message-dots'></i>Góp ý</a></li>
            <?php } ?>
        </ul>
        <ul class="side-menu">
            <li>
            ...
            <div class="header">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        /
                        <li><a href="/PassdoSV.com/backend/xacnhan/xacnhan.php" class="active">Góp ý</a></li>
                    </ul>
                </div>
                <a href="#" class="report">
                            ...
                            <tbody>
                                <?php foreach ($dataGY as $gy) : ?>
                                    <tr>
                                        ...
                                        <td><?= $gy['gy_noidung'] ?></td>
                                        <td>
                                            <a href="send.php?gy_ma=<?= $gy['gy_ma'] ?>"><i class='bx bx-mail-send'></i></a>
                                            <a href="delete.php?gy_ma=<?= $gy['gy_ma'] ?>"><i class='bx bx-message-x'></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
