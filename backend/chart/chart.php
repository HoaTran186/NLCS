    ...
    <body>
        <div class="sidebar">
            ...
            <ul class="side-menu">
                ...
                <li class="active"><a href="/PassdoSV.com/backend/chart/chart.php"><i class='bx bx-line-chart'></i>Thống kê</a></li>
                ...
                <div class="header">
                    <div class="left">
                        ...
                        <ul class="breadcrumb">
                            ...
                            /
                            <li><a href="/PassdoSV.com/backend/chart/chart.php" class="active">Thống kê</a></li>
                        </ul>
                    </div>
                    <a href="#" class="report">
                ...
                <div class="bottom-data">
                    <div class="orders">
                        <div class="header">
                            ...
                            <h3>Tổng sản phẩm hàng tháng</h3>
...
<?php if ($_SESSION['kh_quantri'] == true) : ?>
    <script src="/PassdoSV.com/backend/chart/chartsJS1.js"></script>
<?php else : ?>
    <script src="/PassdoSV.com/backend/chart/chartsJS2.js"></script>
<?php endif; ?>
