                ...
                <div class="col-xl-6 col-lg-7">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li class="active"><a href="#">Danh mục sản phẩm</a>
                                <ul class="dropdown">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <a href="/PassdoSV.com/sanpham.php">Sản phẩm</a>
                            ...
                            <div class="sidebar__color">
                                ...
                                <div class="size__list color__list">
                                    <label>
                                        ...
                                        <?php else : ?>
                                            <input type="checkbox" id="lsp_ma1" name="lsp_ma1" value="1">
                                            <span class="checkmark"></span>
                                        <?php endif; ?>
                                    </label>
                                    <label>
                        ...
                        <?php foreach ($dataLSP as $lsp) : ?>
                            ...
                            <?php else : ?>
                                ...
                                <?php else : ?>
                                    <div class="col-lg-4 col-md-6">
                                        <div class="product__item">
                                            <form action="/PassdoSV.com/giaohang.php" method="post">
                                                <div class="product__item__pic set-bg" data-setbg="/PassdoSV.com/assets/upload/<?= $lsp['hsp_tentaptin'] ?>">
                                                    <ul class="product__hover">
                                                        <li><a href="/PassdoSV.com/assets/upload/<?= $lsp['hsp_tentaptin'] ?>" class="image-popup"><span class="arrow_expand"></span></a></li>
                                                        <li><a href="#"><span class="icon_heart_alt"></span></a></li>
